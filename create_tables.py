...
def create_database():
    ...
    conn = psycopg2.connect("host=localhost dbname=postgres user=pg password=postgres")
    ...
    conn = psycopg2.connect("host=localhost dbname=sparkifydb user=pg password=postgres")
    cur = conn.cursor()
